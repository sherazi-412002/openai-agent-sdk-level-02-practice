...
class CheckBudgetTool(FunctionTool):
    name: str = "check_budget"
    instructions: str = "Checks if a budget is sufficient for a given project type. Takes 'budget' (int) and 'project_type' (str) as input."
    
    def run(self, budget: int, project_type: str) -> str:
...
class CheckCompanyTypeTool(FunctionTool):
    name: str = "check_company_type"
    instructions: str = "Checks if a company is qualified for a project type. Takes 'company_type' (str) and 'project_type' (str) as input."
    
    def run(self, company_type: str, project_type: str) -> str:
...
agent = Agent(
    ...
    tools=[CheckBudgetTool(), CheckCompanyTypeTool()]
)
# -----------------------------------------
# Running the Agent
# -----------------------------------------
